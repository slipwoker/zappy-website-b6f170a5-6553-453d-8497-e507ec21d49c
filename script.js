    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var response = await fetch(apiBase + '/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'b6f170a5-6553-453d-8497-e507ec21d49c',
                    name: data.name || '',
                    email: data.email || '',
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b6f170a5-6553-453d-8497-e507ec21d49c';
...
;(function(){
  ...
  function _zappyMenuContrastFix(){
    ...
    var menuBg='#0B1220';var menuText='#F9FAFB';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b6f170a5-6553-453d-8497-e507ec21d49c';
